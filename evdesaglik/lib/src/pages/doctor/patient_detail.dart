...
class _PatientDetailScreenState extends State<PatientDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.patientData['nameSurname'],
            style: TextStyle(
      ...
      body: SingleChildScrollView(
          ...
          padding: EdgeInsets.only(top: 16, bottom: 156),
          child:
            ...
            button(
              ...
              onTap: () async {
                loading = true;
                setState(() {});
                await Functions.updatePatientData(
                    widget.patientData['uid'],
                    ageController.text,
